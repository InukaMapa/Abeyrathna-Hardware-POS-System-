    ...
    return (
        <div className="top-bar">
            ...
            <div className="user-actions flex items-center gap-4">
                <button className="icon-btn text-[var(--text-primary)] hover:text-[var(--accent-color)] transition-colors bg-transparent border-none cursor-pointer">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div
                    className="relative flex items-center gap-3 cursor-pointer pl-4 border-l border-[var(--border-color)]"
                ...
                >
                    ...
                    <svg className="w-4 h-4 flex-shrink-0 text-[var(--text-secondary)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {showDropdown && (
                        <div className="absolute top-12 right-0 mt-2 w-56 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl shadow-2xl py-2 z-[1000] animate-fade-in origin-top-right">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2.5 flex items-center gap-3 text-sm text-[var(--text-primary)] hover:bg-[var(--bg-primary)] transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2.5 flex items-center gap-3 text-sm text-[#FF6B6B] hover:bg-[var(--bg-primary)] transition-colors mt-1 border-t border-[var(--border-color)]"
                            >
