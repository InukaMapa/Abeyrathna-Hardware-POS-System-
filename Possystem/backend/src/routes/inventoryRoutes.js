...
router.get('/categories', protect, authorize('ADMIN'), fetchInventoryCategories);
...
router.get('/', protect, authorize('ADMIN'), fetchInventoryList);
router.get('/:id', protect, authorize('ADMIN'), fetchInventoryItemDetails); // Get details
